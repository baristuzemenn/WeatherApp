...
import com.baristuzemen.weatherapp.Activity.MainActivity
import com.baristuzemen.weatherapp.Model.CityResponseApi
import com.baristuzemen.weatherapp.Model.ForecastResponseApi
import com.baristuzemen.weatherapp.databinding.CityViewholderBinding
...
class CityAdapter: RecyclerView.Adapter<CityAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: CityAdapter.ViewHolder, position: Int) {
        ...
        binding.cityViewHolderCityTextView.text= differ.currentList[position].name
